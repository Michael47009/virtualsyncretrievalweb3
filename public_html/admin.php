...
<br>
            ...
            <div class="astt">
                ...
                <span> <?php
                                      $sqll = "SELECT count(uid) as u FROM user_details";
                                      $res = $conn->query($sqll);
...
<div class="astt">
    ...
    <span><?php
                                      $sqllll = "SELECT count(txn_id) as tx FROM withdrawals";
                                      $resss = $conn->query($sqllll);
                                      
                                      if ($resss->num_rows > 0) {
                                          while($roo = $resss->fetch_assoc()) {
                                              echo "".$roo["tx"];
